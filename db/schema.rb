...
ActiveRecord::Schema.define(version: 20150330151932) do
  ...
  add_index "events", ["comunne_id"], name: "index_events_on_comunne_id", using: :btree
  ...
  create_table "providers", force: :cascade do |t|
    ...
    t.string   "company_comunne",        default: "", null: false
